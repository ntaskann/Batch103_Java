...
public class Cat_OverrideNotes extends Mammal{
 ...
 /*
        ...
        1)Override yaparken "method'un body" si degistirilir. ==> "System.out.println"
        ...
        4)Override yaparken "access modifier" lar belli kurallara gor farklilastirilabilirler
         ...
         10) "final" methodlar owerride edilemezler cunku overriding'de method body degistirilir fakat
              "final" method body degistirilmesine musade etmez.
         11) Polymorfizm = Overloading + Overriding
              Note: Polymorfizm nedir derlerse Overloading ve Overriding'i anlatin.
