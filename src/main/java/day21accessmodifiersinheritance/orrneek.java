    ...
    public static void main(String[] args) {
         ...
         * */
            ...
            for (int i =0;i<gunler.length;i++){
                System.out.println("Lütfen "+(gunler[i])+" günü kazancını giriniz.");
                double kazanc=input.nextDouble();
                gunlukKazanclar.add(kazanc);
                System.out.println(gunler[i] +" günü kazancınız : "+kazanc+" $");
                toplam +=kazanc;
            }

            System.out.println();
            System.out.println("Haftalık kazancınız : "+toplam+" $");
            System.out.println();
            double ortalamaKazanc=toplam/gunler.length;
            System.out.println("Ortalama kazancınız : "+ortalamaKazanc+" $");
            System.out.println();

            for (int x=0;x<gunler.length;x++){
                if (gunlukKazanclar.get(x)<ortalamaKazanc){
                    System.out.println(gunler[x]+" : Günü kazancınız ortalama kazancınızdan düsüktür.");
                } else if (gunlukKazanclar.get(x)>ortalamaKazanc) {
                    System.out.println(gunler[x]+ " : Günü kazancınız ortalama kazancınızdan yüksektir.");
                }else System.out.println(gunler[x]+" : Günü kazancınız ortalama kazancınıza eşittir.");
